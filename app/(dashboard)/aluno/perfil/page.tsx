    ...
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-0.5">Gerenciar informações pessoais</p>
        </div>
      </div>
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleUpdate} className="space-y-6">
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div className="space-y-1.5">
                <Label className="text-[10px] font-black uppercase text-gray-400 pl-1 tracking-widest">CPF</Label>
                <div className="relative">
              ...
              <div className="space-y-1.5">
                <Label className="text-[10px] font-black uppercase text-gray-400 pl-1 tracking-widest">Data de Nascimento</Label>
                <div className="relative">
      ...
      <p className="text-center text-[10px] font-black uppercase text-gray-400 tracking-tighter">
        Seus dados são protegidos e usados apenas para fins acadêmicos e financeiros.
      </p>
    </div>
  )
}
