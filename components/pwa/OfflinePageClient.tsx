  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-6 py-12">
      <div className="glass-card w-full max-w-xl overflow-hidden p-8 text-center">
        ...
        <p className="mt-6 text-xs font-black uppercase tracking-widest text-rose-500">Sem conexão</p>
        ...
        <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-2xl bg-blue-600 px-5 py-3 text-xs font-black uppercase tracking-widest text-white shadow-lg shadow-blue-500/20"
          >
          ...
          <Link
            href="/login"
            className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-5 py-3 text-xs font-black uppercase tracking-widest text-slate-600"
          >
            Ir para login
          </Link>
        </div>
