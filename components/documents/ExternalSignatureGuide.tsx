...
export default function ExternalSignatureGuide({
  ...
  return (
    <div className={`rounded-[1.5rem] border border-amber-200 bg-amber-50/90 ${compact ? 'p-4' : 'p-6'}`}>
        ...
        <div className="space-y-3">
          <div>
            ...
            <h3 className="mt-1 text-sm font-black text-amber-950">
              {audience === 'professor' ? 'Assinatura externa via ZapSign' : 'Assinatura formal do contrato'}
            </h3>
          </div>
            ...
            <>
              ...
              <div className={`grid gap-3 ${compact ? 'md:grid-cols-2' : 'md:grid-cols-4'}`}>
                ...
                <div className="rounded-2xl bg-white/80 p-3">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-widest text-amber-700">3. Enviar no ZapSign</p>
                  <p className="mt-1 text-xs font-medium text-amber-900/80">Suba o PDF manualmente para coleta de assinaturas.</p>
                </div>
                <div className="rounded-2xl bg-white/80 p-3">
